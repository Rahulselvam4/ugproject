...
//     mysqli_query($conn, "insert into cartfarmer(farmer_id,area,Mobile,Location,Soiltype,Amount,years,description,document,cartid,user_id)values('$farmer_id','$plot_area ','$plot_Number','$Location','$soil','$Amount','$years','$Description','$document','$cartid','$userId')")or die("query wrong");
 ...
 <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5" id="home">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto py-0">
                ...
                <a href="cartfarmer.php" class="nav-item nav-link active ">Land Cart</a>
   ...
   <div class="products">
        <div class="box-container">
            <!-- <form > -->
                <?php
                   $select = mysqli_query($conn, "select * from cartfarmer where farmer_id='$farmer_id'");
