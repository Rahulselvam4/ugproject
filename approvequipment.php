 ...
 <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5" id="home">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto py-0">
                ...
                <a href="approvequipment.php" class="nav-item nav-link active">Approved equipment</a>
   ...
   <div class="products">
        <div class="box-container">
            <!-- <form > -->
                <?php
                   $select = mysqli_query($conn, "select * from cartequipment where user_id='$user_id'");
